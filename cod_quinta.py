...
estanteR = img_cut("Estante/Estanteampli.png", 1600, 900)
...
pastaverdeR, pastaverdepressed = img_cut("pastaverde.png", 100, 215), img_cut("pastaverdepressed.png", 100, 215)
...
inic = pygame.image.load("quiz/Iniciar_quiz.png")
