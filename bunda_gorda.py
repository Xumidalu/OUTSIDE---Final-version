...
inventory_screen = img_cut("inventário.png", 1600, 900)
...
valvula = img_cut("Botão_valvula.png", 50, 50)
abrir, abrir_pressed = img("abrir.png"), img("abrir_pressed.png")
bixinestrain = img_cut("bixinestranho.png", 500, 500)
dedindocao = img_cut("dedindocão.png", 500, 500)
fichakleitin = img_cut("fichinhadoKleitin.png", 500, 500)
loucuras, loucurasBIG = img("importLoUcUrAs.png"), img_cut("importLoUcUrAs.png", 300, 300)
...
pau, pauBIG = img_cut("pau.png", 130, 7), img_cut("pau.png", 390, 21)
...
# TEMPERATURAS
grau1 = img_cut("grau1.png", 124.4, 49.8)
grau2 = img_cut("grau2.png", 124.4, 49.8)
grau3 = img_cut("grau3.png", 124.4, 49.8)
grau4 = img_cut("grau4.png", 124.4, 49.8)


# QUIZ DE VARJÃO

inic, vaii = img("Iniciar.png"), img("vai.png")
...
class SaladasGarrafonas:
    ...
    def handle_events(self):
        ...
        if self.avante.check_click():
            self.msg = False
        if self.puzzlegarrafa.check_click():
...
class Estante:
    def __init__(self):
        ...
        window.blit(pastaroxaampli, (500, 10))
        window.blit(pastaverdeampli, (500, 10))
        ...
        self.volta = Button(300, 300, seta_left, seta_left_hover)
        self.abrir = Button(500, 100, abrir, abrir_pressed)
        self.Ca = False
        self.Pr = False
        self.Pv = False
        self.princ = True
...
class Arquivos:
    def __init__(self):
        window.fill("DimGray")
        self.caixa = black_square
        self.bixinfei = Button(300, 100, bixinestrain, bixinestrain)
        self.dedindocao = Button(700, 100, dedindocao, dedindocao)
        self.kleitin = Button(500, 100, fichakleitin, fichakleitin)
    def handle_events(self):
        global pasta1, pasta2, history
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                pygame.quit
                quit()
...
class PuzzleGarrafas:
    def __init__(self):
        ...
        self.valv1 = Button(400, 400, valvula, seta)
        self.valv2 = Button(700, 400, valvula, seta)
        self.valv3 = Button(1200, 400, valvula, seta)
