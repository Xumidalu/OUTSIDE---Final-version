...
tela2_puzzle1 = pygame.image.load(os.path.join(dir_img, "puzzle_senha.png")).convert_alpha()
tela2_puzzle1 = pygame.transform.scale(tela2_puzzle1, (1600, 900))
...
class PuzzleSalaUmParaDois:
    def __init__(self):
        self.current_screen = tela1_puzzle1
        window.blit(self.current_screen, (0, 0))
        self.next_screen = False
        self.varControle = 0
        self.maxTime = 900
        self.text_input = recadinhos(texto10, WHITE)
    ...
    def update(self):
        window.blit(self.current_screen, (0, 0))
        self.varControle += 0.5
        if self.varControle >= self.maxTime:
            self.current_screen = tela2_puzzle1
            self.varControle = 0
            window.blit(self.text_input, (720, 420))
...
while run:
    ...
    elif tela_atual == "puzzle1":
        tela_atual = puzzle1.handle_events()
        puzzle1.update()
