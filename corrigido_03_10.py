...
# IMPORTES AINDA NÃO ORGANIZADOS
...
class Sala_das_Garrafa_pt_2:
    def __init__(self):
        ...
        self.three = False
        self.four = False
        self.left = Button(250, 500, seta_preta_esquerda, seta_preta_esquerda_pressionada)
        self.right = Button(1350, 500, seta_preta_direita, seta_preta_direita_pressionada)
